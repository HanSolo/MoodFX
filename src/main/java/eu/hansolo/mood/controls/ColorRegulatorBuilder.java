...
public class ColorRegulatorBuilder<B extends ColorRegulatorBuilder<B>> {
    ...
    public final B onButtonAutoClicked(final EventHandler<MouseEvent> HANDLER) {
        properties.put("onButtonAutoClicked", new SimpleObjectProperty<>(HANDLER));
        return (B)this;
    }
    ...
    public final ColorRegulator build() {
        ...
        for (String key : properties.keySet()) {
            ...
            } else if ("onButtonAutoClicked".equals(key)) {
                CONTROL.setOnButtonAutoClicked(((ObjectProperty<EventHandler>) properties.get(key)).get());
